...
class MoodleAPI {
    ...
    public function getCourseInfo(int $courseId): array {
        ...
        $courseInfo['url'] = $this->getCourseUrl($courseId);
        return $courseInfo;
    }
    ...
    private function getCourseUrl(int $courseId): string {
        return sprintf('%s/course/view.php?id=%d', $this->baseUrl, $courseId);
    }
    ...
    private function getBBBActivityUrl(int $courseId, int $cmid): string {
        return sprintf('%s/mod/bigbluebuttonbn/view.php?id=%d', $this->baseUrl, $cmid);
    }
    ...
    private function makeRequest(string $function, array $params = []): array {
        $url = sprintf('%s/webservice/rest/server.php', $this->baseUrl);
        ...
        error_log("API Request: {$function}");
